...
const E = {
  ...
  inclineShoulder:{name:{en:"65–75° Incline Shoulder Press — Dumbbell or Smith Machine",es:"Press de hombros inclinado 65–75° — Mancuernas o máquina Smith",ru:"Жим на плечи под углом 65–75° — гантели или машина Смита",tr:"65–75° Eğimli Omuz Press — Dambıl veya Smith Machine"},note:{en:"Set the bench to about 65–75°. Use dumbbells or a Smith machine. Keep the press controlled and shoulder-focused.",es:"Ajusta el banco a unos 65–75°. Usa mancuernas o máquina Smith. Mantén el press controlado y enfocado en los hombros.",ru:"Установи скамью примерно на 65–75°. Используй гантели или машину Смита. Выполняй жим контролируемо с акцентом на плечи.",tr:"Bench açısını yaklaşık 65–75° yap. Dambıl veya Smith machine kullan. Pressi kontrollü ve omuz odaklı yap."}},
  ...
  tricepsChoice:{name:{en:"Triceps Choice — Bench Dips OR Skull Crushers",es:"Opción de tríceps — Fondos en banco O extensión tumbada",ru:"Трицепс на выбор — отжимания от скамьи ИЛИ французский жим",tr:"Triceps Seçimi — Bench Dips VEYA Skull Crusher"},note:{en:"Choose ONE exercise per session. Use 2 hard sets of 8–15 reps; there is no need to do both after weighted dips and the shoulder press.",es:"Elige SOLO un ejercicio por sesión. Haz 2 series duras de 8–15 repeticiones; no hace falta hacer ambos después de fondos lastrados y el press de hombros.",ru:"Выбирай ОДНО упражнение за тренировку. Выполни 2 тяжёлых подхода по 8–15 повторений; после брусьев с весом и жима на плечи оба упражнения не нужны.",tr:"Her antrenmanda SADECE birini seç. 2 ağır set × 8–15 yap; weighted dips ve omuz press sonrası ikisini birden yapmana gerek yok."}},
...
const PROGRAM = {
  "upper-a":[["pullup","w2w2","3–5","2–3 min"],["dips","w2w2","3–5","2–3 min"],["ohp","w2w2","5–8","2–3 min"],["skull","w2","8–15","2–3 min"],["backExtension","w1","12–20","2–3 min"],["wristCurl","w1","15–25","2–3 min"]],
  "lower-a":[["squat","w2w2","5–8","2–3 min"],["bulgarian","w2","8–15 / leg","2–3 min"],["ham","w2","10–15","2–3 min"],["extension","w2","10–15","2–3 min"],["decline","w2","10–20","2–3 min"]],
  "cardio-1":[["cardio","s1","30–40 min","—"]],
  "upper-b":[["dips","w2","8–12","2–3 min"],["pullup","w2","6–10","2–3 min"],["inclineShoulder","w2","8–15","2–3 min"],["pec","w2","8–15","2–3 min"],["row","w2","8–15","2–3 min"],["lateral","w2","12–20","2–3 min"],["rear","w2","12–20","2–3 min"],["curl","w2","8–15","2–3 min"],["tricepsChoice","w2","8–15","2–3 min"]],
  "lower-b":[["legpress","w2w2","8–15","2–3 min"],["bulgarian","w2","8–15 / leg","2–3 min"],["ham","w2","10–15","2–3 min"],["extension","w2","10–15","2–3 min"],["decline","w2","10–20","2–3 min"]],
